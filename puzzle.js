...
function puzzleCorrrectAnswer1(){
  if(mousePressedOver(puzzleOption1)|| touches>0 || correct1.visible === true){
    counter = 1
    touches = [];
  ...
  if(mousePressedOver(puzzleOption2) || mousePressedOver(puzzleOption3) || mousePressedOver(puzzleOption4)||touches>0 || wrong.visble === true){
    wrong.visible = true;
    touches = [];
    puzzle.visible = false;
    puzzleQ1.visible = false;
